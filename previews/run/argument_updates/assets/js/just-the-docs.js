...
function initSearch() {
  ...
  request.open('GET', '/previews/run/argument_updates/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/previews/run/argument_updates/assets/css/just-the-docs-' + theme + '.css');
}
