...
function initSearch() {
  ...
  request.open('GET', '/previews/run/multilingual/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/previews/run/multilingual/assets/css/just-the-docs-' + theme + '.css');
}
