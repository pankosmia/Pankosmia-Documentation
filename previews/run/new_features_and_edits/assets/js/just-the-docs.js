...
function initSearch() {
  ...
  request.open('GET', '/previews/run/new_features_and_edits/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/previews/run/new_features_and_edits/assets/css/just-the-docs-' + theme + '.css');
}
