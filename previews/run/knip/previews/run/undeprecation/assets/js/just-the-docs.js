...
function initSearch() {
  ...
  request.open('GET', '/previews/run/undeprecation/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/previews/run/undeprecation/assets/css/just-the-docs-' + theme + '.css');
}
