...
function initSearch() {
  ...
  request.open('GET', '/previews/run/debug_log_level_swap/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/previews/run/debug_log_level_swap/assets/css/just-the-docs-' + theme + '.css');
}
