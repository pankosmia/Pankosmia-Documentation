...
function initSearch() {
  ...
  request.open('GET', '/previews/run/no_horizontal_scroll/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/previews/run/no_horizontal_scroll/assets/css/just-the-docs-' + theme + '.css');
}
