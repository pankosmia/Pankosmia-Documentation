...
function initSearch() {
  ...
  request.open('GET', '/previews/run/update_requirements/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/previews/run/update_requirements/assets/css/just-the-docs-' + theme + '.css');
}
