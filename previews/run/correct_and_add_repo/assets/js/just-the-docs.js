...
function initSearch() {
  ...
  request.open('GET', '/previews/run/correct_and_add_repo/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/previews/run/correct_and_add_repo/assets/css/just-the-docs-' + theme + '.css');
}
