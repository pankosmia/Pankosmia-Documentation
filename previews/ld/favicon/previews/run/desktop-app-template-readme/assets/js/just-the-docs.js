...
function initSearch() {
  ...
  request.open('GET', '/previews/run/desktop-app-template-readme/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/previews/run/desktop-app-template-readme/assets/css/just-the-docs-' + theme + '.css');
}
