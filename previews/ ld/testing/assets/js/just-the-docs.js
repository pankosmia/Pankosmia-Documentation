...
function initSearch() {
  ...
  request.open('GET', '/previews/%20ld/testing/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/previews/%20ld/testing/assets/css/just-the-docs-' + theme + '.css');
}
