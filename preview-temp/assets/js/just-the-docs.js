...
function initSearch() {
  ...
  request.open('GET', '/previews/run/decluttering/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/previews/run/decluttering/assets/css/just-the-docs-' + theme + '.css');
}
